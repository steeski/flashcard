criaCartao {                    
    ...
    criaCartao {
    'física';
    'As grandezas físicas escalares são expressas apenas pelo seu valor numérico e unidade de medida. As grandezas físicas vetoriais além do valor numérico e unidade de medida, para serem expressas, necessitam de direção e sentido.
    ...
    criaCartao {
    'química';
    'Vazamento de petróleo, um drama recorrente
    ...
    criaCartao {
    'história';
    'Entende-se comumente por Monarquia aquele sistema de dirigir que se centraliza estavelmente numa só pessoa investida de poderes especialíssimos, exatamente monárquicos, que a colocam claramente acima de todo o conjunto dos governados. 
    ...
    criaCartao {
    'história';
    'O iluminismo (ou ilustração) foi uma corrente de ideias que teve origem no século XVII e se desenvolveu sobretudo no século XVIII. O referido movimento é considerado importante por transformar a visão tradicional do homem moderno. 
     O iluminismo expressou a';
    'consolidação do uso da razão, ou racionalismo, como elemento essencial do ser humano.';}
    
    criaCartao {
    'história';
    'No ano de 1945, bombas nucleares destruíram as cidades japonesas de Hiroshima e Nagasaki, impressionando o mundo pelo seu poder de devastação.
